...
/*
    ...
    Cmdline:
        sokol-shdc --input C:\dev\VEFontCache-Odin\backend\sokol\draw_text.shdc.glsl --output C:\dev\VEFontCache-Odin\backend\sokol\draw_text.odin --slang glsl410:glsl300es:hlsl4:metal_macos:wgsl --format=sokol_odin
