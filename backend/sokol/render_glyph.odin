...
/*
    ...
    Cmdline:
        sokol-shdc --input C:\dev\VEFontCache-Odin\backend\sokol\render_glyph.shdc.glsl --output C:\dev\VEFontCache-Odin\backend\sokol\render_glyph.odin --slang glsl410:glsl300es:hlsl4:metal_macos:wgsl --format=sokol_odin
